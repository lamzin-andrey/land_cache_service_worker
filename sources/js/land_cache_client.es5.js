...
var P = LandCacheClient.prototype;
/**
...
*/
P.getAllResourcesHash = function() {
	var i, n = 0, o = this;
	for (i in o._aUrlMap) {
		n++;
		break;
 ...
 * @param {String} sHost
*/
P._addResource = function(aResources, oItem, sAttrName, sHost) {
	var co, src, o = this;
	if (o._aUrlMap[src]) {
		return;
	}
 ...
 * @return Boolean
*/
P._isOurHost = function(src, sHost) {
	if (!src) {
		return false;
	}
	if (src.charAt(0) == '/') {
